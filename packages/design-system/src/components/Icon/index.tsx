...
export const Icon = {
  Calendar: ({ size = 20, fill }: IconProps) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={cx("icon", fill)}
      width={size}
      height="auto"
      viewBox="0 0 16 18"
      fill="none"
